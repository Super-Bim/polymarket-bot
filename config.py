...
GALE_1_PRICE_THRESHOLD   = 0.47  # Max price for Gale 1 specifically
ENTRY_WINDOW_SECONDS     = 120   # 1st order entry window (seconds)
MARTINGALE_WINDOW_SECONDS= 240   # Total window for martingale (seconds)
...
# --- Polling ---
PRICE_POLL_INTERVAL      = 4     # Seconds between price checks
